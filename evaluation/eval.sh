python -u -m evaluation.eval \
    --device cuda:0 \
    --load /data/rrjin/NMT/tmpdata/model_basic_multi_gpu_lstm__9_0.322549 \
    ...
    --translation_output /data/rrjin/NMT/tmpdata/beam_translations_basic_multi_gpu_lstm.txt \
    --multi_gpu True