python -u -m evaluation.eval \
    --device cuda:0 \
    --load /data/rrjin/NMT/tmpdata/model_basic_multi_gpu_lstm5__11_0.222230 \
    ...
    --translation_output /data/rrjin/NMT/tmpdata/beam_translations_basic_multi_gpu_lstm7.txt